...
```javascript
import scopy from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-scopy-wasm@esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { Module } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-scopy-wasm@esm/index.mjs';
```
